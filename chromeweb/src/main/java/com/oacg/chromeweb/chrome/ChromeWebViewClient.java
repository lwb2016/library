...
public class ChromeWebViewClient extends BaseWebClient<WebView> {
    private String TAG="ChromeWebViewClient";

    public ChromeWebViewClient(Context context, @NonNull WebView webView) {
        super(context, webView);
    }

    public ChromeWebViewClient(Context context, @NonNull ViewGroup viewGroup) {
        super(context, null);
    ...
    private void newWebView(ViewGroup viewGroup) {
        if(viewGroup==null)
            return;
        mWebView=new CusWebView(viewGroup.getContext());
