...
public class DownLoadDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        createLocalDownloadInfoTable(db);
    }
    ...
    private void createLocalDownloadInfoTable(SQLiteDatabase db){
        db.execSQL("create table " + TABLE_LOCALDOWNLOAD_INFO + "("
                + "id integer PRIMARY KEY AUTOINCREMENT,"
                + "name varchar(50),"
                + "url varchar(100),"
